...
namespace XEditor
{
    public class SelectBonesEditor : EditorWindow
    {
        ...
        private bool CopyValue<T>(GameObject srcGO, GameObject destGO) where T : Component
        {
            ...
            if (srcCC == null) return false;
            T destCC = destGO.GetComponent<T>();
            if (destCC == null) destCC = destGO.AddComponent<T>();
    ...
    public class SelectEquipBones : SelectBonesEditor
    {
